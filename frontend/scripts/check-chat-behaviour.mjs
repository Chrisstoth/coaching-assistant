...
assert.match(profileWizard, /Carry over existing profile evidence/, 'Existing profile evidence should be offered before a new foundation interview.')
assert.match(profileWizard, /No AI call · no tokens used/, 'Profile carry-over should make its zero-token behaviour explicit.')
assert.match(profileWizard, /Confirm and save reviewed fields/, 'Foundation carry-over must require coach confirmation.')
assert.match(profileWizard, /nothing changes until you confirm/, 'The preview-only behaviour should be clear to the coach.')
...
assert.match(api, /updateException/, 'Availability records should expose an update API.')
assert.match(swimmerDetail, /editException/, 'Saved swimmer availability should be editable.')
assert.match(swimmerDetail, /Save Changes/, 'The availability form should clearly confirm an edit.')
assert.match(swimmerDetail, /setDeleteError/, 'Swimmer deletion failures should stay visible in the confirmation dialog.')
assert.match(swimmerDetail, /The swimmer could not be removed/, 'Swimmer deletion should always have a useful fallback error.')
